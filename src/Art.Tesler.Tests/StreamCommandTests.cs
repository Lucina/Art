...
public class StreamCommandTests : CommandTestBase
{
    ...
    {
        Command = new StreamCommand(toolLogHandlerProvider, artifactToolRegistryStore, toolDefaultPropertyProvider, profileResolver);
    }
    ...
    public void NoProfilesPassed_Fails()
    {
        ...
        InitCommandDefault(toolOutput, store, toolDefaultPropertyProvider, profileResolver);
