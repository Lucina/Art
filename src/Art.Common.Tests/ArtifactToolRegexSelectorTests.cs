...
public class ArtifactToolRegexSelectorTests
{
    ...
    private static bool TryIdentify<T>(string key, out ArtifactToolID artifactToolId, [NotNullWhen(true)] out string? artifactId) where T : IArtifactToolSelector<string>
    {
