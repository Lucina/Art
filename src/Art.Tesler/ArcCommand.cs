...
public class ArcCommand : ToolCommandBase
{
    ...
    public ArcCommand(
        ...
        : this(toolLogHandlerProvider, pluginStore, toolDefaultPropertyProvider, dataProvider, registrationProvider, profileResolver, "arc", "Execute archival artifact tools.")
    {
    }
